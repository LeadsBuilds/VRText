...
namespace VRText.SharpOSC
{
	public struct Timetag
	{
		...
		public DateTime Timestamp
		{
			get
			{
				return global::VRText.SharpOSC.Utils.TimetagToDateTime(Tag);
			}
			set
			{
				Tag = global::VRText.SharpOSC.Utils.DateTimeToTimetag(value);
			}
		}
		...
		public double Fraction
		{
			get
			{
				return global::VRText.SharpOSC.Utils.TimetagToFraction(Tag);
			}
			set
			{
