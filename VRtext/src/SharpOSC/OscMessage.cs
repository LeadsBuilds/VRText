		...
		public override byte[] GetBytes()
		{
			...
			while (i < currentList.Count)
			{
				...
				switch (type)
				{
					...
					case "SharpOSC.Midi":
						typeString += "m";
						parts.Add(setMidi((VRText.SharpOSC.Midi)arg));
						break;
					case "System.Boolean":
			...
			int addressLen = (Address.Length == 0 || Address == null ) ? 0 : global::VRText.SharpOSC.Utils.AlignedStringLength(Address);
			int typeLen = global::VRText.SharpOSC.Utils.AlignedStringLength(typeString);
			...
			string ooutput = Encoding.UTF8.GetString(output);
